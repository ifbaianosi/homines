...
-- -----------------------------------------------------
-- Table `homines`.`situation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `homines`.`situation` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `situation` VARCHAR(45) NULL,
  `situation_date` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `homines`.`employee` (
  ...
  `inactive_reason` VARCHAR(45) NULL,
  `observation` VARCHAR(200) NULL,
  `term_of_contract` VARCHAR(45) NULL,
  ...
  PRIMARY KEY (`id`, `career_id`, `classes_id`, `stand_id`, `post_id`, `sector_id`, `situation_id`),
  ...
  INDEX `fk_employee_situation1_idx` (`situation_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_employee_sector1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_situation1`
    FOREIGN KEY (`situation_id`)
    REFERENCES `homines`.`situation` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
